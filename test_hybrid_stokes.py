...
# plot_train_val_losses(tau_levels=tau, ckpts_path=ckpts_path, model_type=model_types, title = "Hybrid Stokes Models -> vz Train and Validation Losses", name='hybrid_stokes_vz_deepvel_models_combined', save_path=ckpts_path)
...
checkpoints = ["/home/xenoss/dat/thesis/models/v4/tau_1e-1/hybrid_vz/checkpoints/DeepVel_torch_epoch_178_0.01918.pt"]
...
for i, ckpt in enumerate(checkpoints):
    ...
    deepvel_net = DeepVel_run(root = main_root, tau = taus[i], in_shape = input_shape, out_shape=(1, 16, 16), batch = 32, dataset_path = dataset_path, network_path = model_path, test=True)
