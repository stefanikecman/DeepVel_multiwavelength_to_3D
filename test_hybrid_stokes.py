...
checkpoints = [
    ...
    f"/home/xenoss/dat/thesis/models/{version}/tau_1e-1/hybrid_model/checkpoints/DeepVel_torch_epoch_99_0.06091.pt", #tau=1e-1
    f"/home/xenoss/dat/thesis/models/{version}/tau_1e-2/hybrid_model/checkpoints/DeepVel_torch_epoch_98_0.08250.pt", #tau=1e-2
    f"/home/xenoss/dat/thesis/models/{version}/tau_1e-3/hybrid_model/checkpoints/DeepVel_torch_epoch_99_0.17897.pt", #tau=1e-3
    #f"/home/xenoss/dat/thesis/models/{version}/tau_1e-4/hybrid_model/checkpoints/DeepVel_torch_epoch_165_0.20996.pt"  #tau=1e-4
    ]
...
# csvs = [f"hybrid_stokes_{version}_{taus[i]}_" for i in range(len(taus))]
# common_csv = []
